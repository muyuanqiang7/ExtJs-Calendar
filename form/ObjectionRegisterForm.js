//异议登记信息
Ext.define('app.platform.archives.view.itemPages.ObjectionRegisterForm', {
    extend: 'Ext.panel.Panel',
    xtype: 'objectionregisterform',
    alias: 'objectionregisterform',
    autoScroll: true,
    margin: '0 0 0 0',
    layout: {
        type: 'vbox',
        ...
        Ext.apply(this, {
            items: [{
                ...
                items: [{
                    ...
                    value: '<span style="color:black;font-size:16px;height:100px;"><b>异议登记信息</b></span>'
                }, {
                    xtype: 'panel',
                    colspan: 5,
                    margin: '0 0 0 0',
