//预告登记信息
Ext.define('app.platform.archives.view.itemPages.AdvanceNoticeRegisterForm', {
    extend: 'Ext.panel.Panel',
    xtype: 'advancenoticeregisterform',
    alias: 'advancenoticeregisterform',
    autoScroll: true,
    margin: '0 0 0 0',
    layout: {
        type: 'vbox',
        ...
        Ext.apply(this, {
            items: [{
                ...
                items: [{
                    ...
                    value: '<span style="color:black;font-size:16px;height:100px;"><b>预告登记信息</b></span>'
                }, {
                    xtype: 'panel',
                    colspan: 5,
                    margin: '0 0 0 0',
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            xtype: 'displayfield',
                            value: '不动产坐落<span style="color:red">*</span>:',
                        },
                        {
                            xtype: 'nobordertextfield',
                            name: 'zddm',
