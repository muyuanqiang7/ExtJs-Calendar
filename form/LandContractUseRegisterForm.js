...
Ext.define('app.platform.archives.view.itemPages.LandContractUseRegisterForm', {
    ...
    xtype: 'landcontractuseregisterform',
    alias: 'landcontractuseregisterform',
    autoScroll: true,
    margin: '0 0 0 0',
    layout: {
        type: 'vbox',
        ...
        Ext.apply(this, {
            items: [{
                ...
                items: [{
                    ...
                    value: '<span style="color:black;font-size:16px;height:100px;"><b>土地承包经营权、农用地的其他使用权登记信息（非林地） </b></span>'
                }, {
                    xtype: 'panel',
                    colspan: 5,
                    margin: '0 0 0 0',
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            xtype: 'displayfield',
                            value: '发包方<span style="color:red">*</span>:',
                        },
                        {
                            xtype: 'nobordertextfield',
                            name: 'zddm',
