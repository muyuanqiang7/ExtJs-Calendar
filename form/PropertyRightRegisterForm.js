//房地产权登记信息（独幢、层、套、间房屋）
Ext.define('app.platform.archives.view.itemPages.PropertyRightRegisterForm', {
    extend: 'Ext.panel.Panel',
    xtype: 'ppropertyrightregisterform',
    alias: 'ppropertyrightregisterform',
    autoScroll: true,
    margin: '0 0 0 0',
    layout: {
        type: 'vbox',
        ...
        Ext.apply(this, {
            items: [{
                ...
                items: [{
                    ...
                    value: '<span style="color:black;font-size:16px;height:100px;"><b>房地产权登记信息（独幢、层、套、间房屋）</b></span>'
                }, {
                    xtype: 'panel',
                    colspan: 5,
                    margin: '0 0 0 0',
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            xtype: 'displayfield',
                            value: '房地坐落<span style="color:red">*</span>',
                        },
                        {
                            xtype: 'nobordertextfield',
                            name: 'zddm',
