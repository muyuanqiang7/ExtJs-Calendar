//建设用地使用权、宅基地使用权登记信息
Ext.define('app.platform.archives.view.itemPages.LandRightOfUseForm', {
    extend: 'Ext.panel.Panel',
    xtype: 'landrightoffuseform',
    alias: 'landrightoffuseform',
    autoScroll: true,
    margin: '0 0 0 0',
    layout: {
        type: 'vbox',
        ...
        Ext.apply(this, {
            items: [{
                ...
                items: [{
                    ...
                    value: '<span style="color:black;font-size:16px;height:100px;"><b>建设用地使用权、宅基地使用权登记信息</b></span>'
                }, {
                    xtype: 'panel',
                    colspan: 5,
                    margin: '0 0 0 0',
