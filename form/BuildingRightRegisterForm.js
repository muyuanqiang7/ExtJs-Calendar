//构（建）筑物所有权登记信息
Ext.define('app.platform.archives.view.itemPages.BuildingRightRegisterForm', {
    extend: 'Ext.panel.Panel',
    xtype: 'buildingrightregisterform',
    alias: 'buildingrightregisterform',
    autoScroll: true,
    margin: '0 0 0 0',
    layout: {
        type: 'vbox',
        ...
        Ext.apply(this, {
            items: [{
                ...
                items: [{
                    ...
                    value: '<span style="color:black;font-size:16px;height:100px;"><b>构（建）筑物所有权登记信息</b></span>'
                }, {
                    xtype: 'panel',
                    colspan: 5,
                    margin: '0 0 0 0',
